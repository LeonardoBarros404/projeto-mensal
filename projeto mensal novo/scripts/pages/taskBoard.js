...
document.addEventListener("DOMContentLoaded", () => {
    const userEmail = getFromLocalStorage("user")?.email;
    if (userEmail) {
        document.getElementById("user-email").textContent = `${userEmail}`;
    } else {
        document.getElementById("user-email").textContent = "Não autenticado";
    }
});
...
function toggleDarkMode() {
    ...
    const bgImage = isDarkMode ? 'noiteModo.png' : 'diaModo.png';
    ...
    toggleDarkModeBtn.textContent = isDarkMode ? 'Modo Claro' : 'Modo Noturno';
}
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (savedMode === 'enabled') {
        ...
        document.body.style.backgroundImage = `url('./noiteModo.png')`;
        toggleDarkModeBtn.textContent = 'Modo Claro';
    } else {
        document.body.style.backgroundImage = `url('./diaModo.png')`;
    }
});
